...
export const dictTypeApi = {
  ...
  create: (data: { code: string; name: string; is_public: boolean; status: number; remark: string }) =>
    request.post('/dict-types', data),
  update: (id: number, data: { code: string; name: string; is_public: boolean; status: number; remark: string }) =>
...
export const dictEntryApi = {
  ...
  create: (typeId: number, data: { label: string; value: string; sort: number; status: number; remark: string }) =>
    request.post(`/dict-types/${typeId}/entries`, data),
  update: (
    typeId: number,
    entryId: number,
    data: { label: string; value: string; sort: number; status: number; remark: string },
