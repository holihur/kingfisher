...
### A-1 `GET /metrics` 未实现
  **Status: ✅ /metrics endpoint (promhttp)**
...
### A-24 迁移与 Wire 完全缺失
  **Status: ✅ Migrations + Wire created**
